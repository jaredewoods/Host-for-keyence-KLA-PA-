...
class ConnectionStatusFrame(ttk.Frame):
    def __init__(self, master=None, dispatcher=None):
        ...
        self.chk_status_3 = ttk.Checkbutton(self, text="  status 3", variable=self.var_status_3, command=None, state='disabled')
        self.chk_status_3.grid(row=2, column=0, sticky="w", padx=10)

        self.var_status_4 = tk.BooleanVar(value=False)
        self.chk_status_4 = ttk.Checkbutton(self, text="  status 4", variable=self.var_status_4, command=None, state='disabled')
