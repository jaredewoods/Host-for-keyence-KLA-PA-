...
from control_frames import SerialControlFrame, TCPControlFrame, MacroControlFrame, ConnectionStatusFrame
from control_services import SerialService, TCPService, MacroService, DisplayService, StatusService
...
class MainWindow(tk.Tk):
    ...
    def create_status_frames(self):
        ...
        sts_connection = ConnectionStatusFrame(sts_connection_tab, dispatcher=self.dispatcher)
